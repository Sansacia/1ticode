...
! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).Modal = {})
}(this, function(e) {
    "use strict";
    var t;
            ...
            if (a || !Object.assign) {
                var r = Object.getOwnPropertyNames(n).map(function(i) {
                    return o({}, i, function(e) {
                        return l(n[e]) && null !== t && t.hasOwnProperty(e) && l(t[e])
                    }(i) ? e(t[i], n[i], a) : n[i])
                }).reduce(function(e, t) {
                    return i({}, e, {}, t)
                }, {});
    ...
    var s, u, d = function(e, t, n, o, a, i, l, r, c, s) {
            "boolean" != typeof l && (c = r, r = l, l = !1);
            var u, d = "function" == typeof n ? n.options : n;
            if (e && e.render && (d.render = e.render, d.staticRenderFns = e.staticRenderFns, d._compiled = !0, a && (d.functional = !0)), o && (d._scopeId = o), i ? (u = function(e) {
                ...
                }, d._ssrRegister = u) : t && (u = l ? function() {
                    t.call(this, s(this.$root.$options.shadowRoot))
                } : function(e) {
                    t.call(this, r(e))
                }), u)
                if (d.functional) {
            ...
            render: function() {
                ...
                return n("transition", {
                    ...
                    style: e.customStyle
                }, [e.component ? n(e.component, e._g(e._b({
                    tag: "component",
                    on: {
                        close: e.close
                    }
                }, "component", e.props, !1), e.events)) : e.content ? n("div", {
                    domProps: {
                        innerHTML: e._s(e.content)
                    }
                }) : e._t("default"), e._v(" "), e.showX ? n("button", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: !e.animating,
            ...
            directives: {
                trapFocus: {
                    bind: function(e, n) {
                        var o, a = n.value;
                        if (void 0 === a || a) {
                            var i = (o = e) ? o.querySelectorAll("a[href],\n                                     area[href],\n                                     input:not([disabled]),\n                                     select:not([disabled]),\n                                     textarea:not([disabled]),\n                                     button:not([disabled]),\n                                     iframe,\n                                     object,\n                                     embed,\n                                     *[tabindex],\n                                     *[contenteditable]") : null;
                            if (i && i.length > 0) {
                                var l = i[0],
                                    r = i[i.length - 1];
                                t = function(e) {
                                    e.target === l && e.shiftKey && "Tab" === e.key ? (e.preventDefault(), r.focus()) : e.target !== r || e.shiftKey || "Tab" !== e.key || (e.preventDefault(), l.focus())
            ...
            props: {
                ...
                canCancel: {
                    type: [Array, Boolean],
                    default: function() {
                        return c.defaultModalCanCancel
                    }
                },
                onCancel: {
                    type: Function,
                ...
                scroll: {
                    type: String,
                    default: function() {
                        return c.defaultModalScroll ? c.defaultModalScroll : "clip"
                    },
            ...
            computed: {
                cancelOptions: function() {
                    return "boolean" == typeof this.canCancel ? this.canCancel ? c.defaultModalCanCancel : [] : this.canCancel
                },
                showX: function() {
            ...
            watch: {
                ...
                isActive: function(e) {
                    var t = this;
                    this.handleScroll(), this.$nextTick(function() {
                        e && t.$el && t.$el.focus && t.$el.focus()
                    })
                }
            },
            methods: {
                ...
                close: function() {
                    ...
                    this.$emit("close"), this.$emit("update:active", !1), this.programmatic && (this.isActive = !1, setTimeout(function() {
                        var t;
                        e.$destroy(), void 0 !== (t = e.$el).remove ? t.remove() : void 0 !== t.parentNode && null !== t.parentNode && t.parentNode.removeChild(t)
                    }, 150))
                },
                keyPress: function(e) {
        ...
        f = {
            open: function(e) {
                ...
                return new(("undefined" != typeof window && window.Vue ? window.Vue : s || void 0).extend(d))({
                    parent: t,
        ...
        p = {
            install: function(e) {
                s = e,
                    ...
                    function(e, t, n) {
                        e.prototype.$buefy || (e.prototype.$buefy = {}), e.prototype.$buefy[t] = n
                    }(e, "modal", f)
            }
        };
    u = p, "undefined" != typeof window && window.Vue && window.Vue.use(u), e.BModal = d, e.ModalProgrammatic = f, e.default = p, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});;
var code;
