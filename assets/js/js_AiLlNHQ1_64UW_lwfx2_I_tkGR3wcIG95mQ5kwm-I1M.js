...
H5P.MarkTheWords.XapiGenerator = (function($) {
  ...
  function XapiGenerator(markTheWords) {
      ...
      this.generateAnsweredEvent = function() {
          ...
          // Set score
          xAPIEvent.setScoredResult(markTheWords.getScore(), markTheWords.getMaxScore(), markTheWords, true, markTheWords.getScore() === markTheWords.getMaxScore());
          // Extend user result
          var userResult = {
  ...
  function getUserSelections(markTheWords) {
      return markTheWords.selectableWords.reduce(function(prev, word, index) {
          if (word.isSelected()) {
              prev.push(index);
          }
          return prev;
...
H5P.MarkTheWords.Word = (function() {
  ...
  function Word($word) {
      ...
      this.markClear = function() {
          $word.removeAttr('aria-selected').removeAttr('aria-describedby');
      };
      /**
...
H5P.MarkTheWords = (function($, Question, Word, KeyboardNav, XapiGenerator) {
  ...
  MarkTheWords.prototype.showEvaluation = function(answers) {
      ...
      var scoreText = this.params.score.replace(/@score/g, score.toString()).replace(/@total/g, this.answers.toString()).replace(/@correct/g, answers.correct.toString()).replace(/@wrong/g, answers.wrong.toString()).replace(/@missed/g, answers.missed.toString());
