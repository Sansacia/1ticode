...
var properties = {
  "!": {
      ...
      "el": [{
          "property": "!important",
          "descr": "Повышает приоритет стиля"
  ...
  "A": {
      ...
      "el": [{
          ...
          "descr": "Выравнивает строки внутри флекс-контейнера при наличии свободного пространства по поперечной оси"
      }, {
          "property": "align-items",
          "descr": "Выравнивает флекс-элементы внутри контейнера в перпендикулярном направлении"
      }, {
          "property": "align-self",
          "descr": "Задаёт выравнивание отдельного элемента в контейнере по поперечной оси"
      }, {
          "property": "all",
          "descr": "Универсальное свойство, которое сбрасывает все значения свойств в исходные или наследуемые"
      }, {
          "property": "animation",
          "descr": "Универсальное свойство, которое задаёт сразу несколько параметров анимации"
      }, {
          "property": "animation-delay",
          "descr": "Устанавливает время ожидания перед запуском цикла анимации"
      }, {
          "property": "animation-direction",
          "descr": "Устанавливает направление движения анимации"
      }, {
          "property": "animation-duration",
          "descr": "Задаёт время в секундах или миллисекундах, сколько должна длиться анимация движения"
      }, {
          "property": "animation-iteration-count",
          "descr": "Устанавливает, сколько раз должен проигрываться анимационный цикл до остановки"
      }, {
          "property": "animation-fill-mode",
          "descr": "Определяет, какие стили должны применяться к элементу, когда анимация не проигрывается"
      }, {
          "property": "animation-name",
          "descr": "Устанавливает одну или несколько анимаций, которые применяются к элементу"
      }, {
          "property": "animation-play-state",
          "descr": "Свойство определяет, проигрывать анимацию или поставить её на паузу"
      }, {
          "property": "animation-timing-function",
          "descr": "Устанавливает, по какой зависимости должна происходить анимация каждого цикла"
      }]
  },
  "B": {
      "gTitle": "B",
      "el": [{
          ...
          "descr": "Применяет эффекты вроде размытия к области фонового рисунка, расположенной за элементом"
      }, {
          "property": "backface-visibility",
          "descr": "Определяет, показывать обратную сторону элемента или нет при его трансформации в трёхмерном пространстве"
      }, {
          "property": "background",
          "descr": "Универсальное свойство позволяет установить одновременно несколько характеристик фона"
      }, {
          "property": "background-attachment",
          "descr": "Устанавливает, будет ли прокручиваться фоновое изображение вместе с содержимым элемента"
      }, {
          "property": "background-blend-mode",
          "descr": "Определяет режим наложения фонового изображения на фоновый цвет или другие фоновые изображения"
      }, {
          "property": "background-clip",
          "descr": "Определяет, как цвет фона или фоновая картинка должна выводиться под границами"
      }, {
          "property": "background-color",
          "descr": "Определяет цвет фона элемента"
      }, {
          "property": "background-image",
          "descr": "Устанавливает фоновое изображение для элемента"
      }, {
          "property": "background-origin",
          "descr": "Определяет область позиционирования фонового рисунка"
      }, {
          "property": "background-position",
          "descr": "Задаёт начальное положение фонового изображения"
      }, {
          "property": "background-position-x",
          "descr": "Задаёт положение фонового изображения внутри элемента по горизонтали"
      }, {
          "property": "background-position-y",
          "descr": "Задаёт положение фонового изображения внутри элемента по вертикали"
      }, {
          "property": "background-repeat",
          "descr": "Определяет, как будет повторяться фоновое изображение"
      }, {
          "property": "background-size",
          "descr": "Масштабирует фоновое изображение, согласно заданным размерам"
      }, {
          "property": "block-size",
          "descr": "Определяет размер элемента по блочной оси, направление которой зависит от значения свойства writing-mode"
      }, {
          "property": "border",
          "descr": "Позволяет одновременно установить толщину, стиль и цвет границы вокруг элемента"
      }, {
          "property": "border-bottom",
          "descr": "Позволяет одновременно установить толщину, стиль и цвет границы внизу элемента"
      }, {
          "property": "border-bottom-color",
          "descr": "Устанавливает цвет границы внизу элемента"
      }, {
          "property": "border-bottom-left-radius",
          "descr": "Устанавливает радиус скругления левого нижнего уголка рамки"
      }, {
          "property": "border-bottom-right-radius",
          "descr": "Устанавливает радиус скругления правого нижнего уголка границы"
      }, {
          "property": "border-bottom-style",
          "descr": "Устанавливает стиль границы внизу элемента"
      }, {
          "property": "border-bottom-width",
          "descr": "Устанавливает толщину границы внизу элемента"
      }, {
          "property": "border-collapse",
          "descr": "Устанавливает, как отображать границы вокруг ячеек таблицы"
      }, {
          "property": "border-color",
          "descr": "Устанавливает цвет границы на разных сторонах элемента"
      }, {
          "property": "border-image",
          "descr": "Используется для отображения рисованной рамки вокруг элемента"
      }, {
          "property": "border-left",
          "descr": "Позволяет одновременно установить толщину, стиль и цвет левой границы элемента"
      }, {
          "property": "border-left-color",
          "descr": "Задаёт цвет границы слева от элемента"
      }, {
          "property": "border-left-style",
          "descr": "Устанавливает стиль границы слева от элемента"
      }, {
          "property": "border-left-width",
          "descr": "Устанавливает толщину границы слева от элемента"
      }, {
          "property": "border-radius",
          "descr": "Устанавливает радиус скругления уголков рамки"
      }, {
          "property": "border-right",
          "descr": "Позволяет одновременно установить толщину, стиль и цвет правой границы элемента"
      }, {
          "property": "border-right-color",
          "descr": "Задаёт цвет границы справа от элемента"
      }, {
          "property": "border-right-style",
          "descr": "Устанавливает стиль границы справа от элемента"
      }, {
          "property": "border-right-width",
          "descr": "Устанавливает толщину границы справа от элемента"
      }, {
          "property": "border-spacing",
          "descr": "Задаёт расстояние между границами ячеек в таблице"
      }, {
          "property": "border-style",
          "descr": "Устанавливает стиль границы вокруг элемента"
      }, {
          "property": "border-top",
          "descr": "Позволяет одновременно установить толщину, стиль и цвет границы сверху элемента"
      }, {
          "property": "border-top-color",
          "descr": "Задает цвет границы сверху элемента"
      }, {
          "property": "border-top-left-radius",
          "descr": "Устанавливает радиус скругления левого верхнего уголка рамки"
      }, {
          "property": "border-top-right-radius",
          "descr": "Устанавливает радиус скругления правого верхнего уголка рамки"
      }, {
          "property": "border-top-style",
          "descr": "Устанавливает стиль границы сверху элемента"
      }, {
          "property": "border-top-width",
          "descr": "Устанавливает толщину границы сверху элемента"
      }, {
          "property": "border-width",
          "descr": "Задаёт толщину границы одновременно на всех сторонах элемента или индивидуально для каждой стороны"
      }, {
          "property": "bottom",
          "descr": "Устанавливает положение нижнего края содержимого элемента без учета толщины рамок и отступов"
      }, {
          "property": "box-decoration-break",
          "descr": "Указывает, как оформлять фрагмент текста при его переносе на другую строку"
      }, {
          "property": "box-shadow",
          "descr": "Добавляет тень к элементу"
      }, {
          "property": "box-sizing",
          "descr": "Применяется для изменения алгоритма расчёта ширины и высоты элемента"
      }]
  },
  "C": {
      "gTitle": "C",
      "el": [{
          ...
          "descr": "Определяет положение заголовка таблицы, который задаётся с помощью элемента <caption>"
      }, {
          "property": "caret-color",
          "descr": "Задаёт цвет текстового курсора, который отображается в текстовых полях формы, а также для элементов с атрибутом contenteditable"
      }, {
          "property": "clear",
          "descr": "Устанавливает, с какой стороны элемента запрещено его обтекание другими элементами"
      }, {
          "property": "clip",
          "descr": "Определяет область позиционированного элемента, в которой будет показано его содержимое"
      }, {
          "property": "color",
          "descr": "Определяет цвет текста элемента"
      }, {
          "property": "column-count",
          "descr": "Определяет количество колонок в многоколоночном тексте"
      }, {
          "property": "column-fill",
          "descr": "Определяет, как контент должен распределяться внутри колонок"
      }, {
          "property": "column-gap",
          "descr": "Задаёт расстояние между колонками в многоколоночном тексте"
      }, {
          "property": "column-rule",
          "descr": "В многоколоночном тексте отрисовывает линию между колонок и задаёт её параметры"
      }, {
          "property": "column-rule-color",
          "descr": "В многоколоночном тексте задаёт цвет линий между колонок"
      }, {
          "property": "column-rule-style",
          "descr": "Определяет стиль линий между колонок в многоколоночном тексте"
      }, {
          "property": "column-rule-width",
          "descr": "В многоколоночном тексте задаёт толщину линий между колонок"
      }, {
          "property": "column-span",
          "descr": "Определяет, как должен отображаться элемент в многоколоночном тексте — занимать ширину всех колонок или только одну из них"
      }, {
          "property": "column-width",
          "descr": "Задаёт оптимальную ширину колонки в многоколоночном тексте"
      }, {
          "property": "columns",
          "descr": "Универсальное свойство, позволяет одновременно задать ширину и количество колонок многоколоночного текста"
      }, {
          "property": "content",
          "descr": "Позволяет вставлять генерируемое содержание в текст веб-страницы, которое первоначально в тексте отсутствует.Позволяет вставлять генерируемое содержание в текст веб-страницы, которое первоначально в тексте отсутствует"
      }, {
          "property": "counter-increment",
          "descr": "Предназначено для увеличения значения счётчика приращений, который задается свойством counter-reset"
      }, {
          "property": "counter-reset",
          "descr": "Устанавливает идентификатор, в котором будет храниться счетчик отображений определенного элемента, а также начальное значение счетчика"
      }, {
          "property": "cursor",
          "descr": "Устанавливает форму курсора, когда он находится в пределах элемента"
      }]
  },
  "DE": {
      "gTitle": "D, E",
      "el": [{
          "property": "direction",
          "descr": "Свойство предназначено для сайтов, в которых имеет значение направление текста"
      }, {
          "property": "display",
          "descr": "Многоцелевое свойство, которое определяет, как элемент должен быть показан в документе"
      }, {
          "property": "empty-cells",
          "descr": "Задаёт отображение границ и фона в ячейке таблицы, если она пустая"
      }]
  },
  "F": {
      "gTitle": "F",
      "el": [{
          "property": "filter",
          "descr": "Используется для добавления художественных эффектов к элементам, обычно к изображениям"
      }, {
          "property": "flex",
          "descr": "Сокращённое свойство, которое позволяет указать параметры элемента, чтобы он эффективно заполнял доступное пространство"
      }, {
          "property": "flex-basis",
          "descr": "Свойство flex-basis определяет основу флекса, которая является начальным размером элемента"
      }, {
          "property": "flex-direction",
          "descr": "Свойство flex-direction определяет, как флексы располагаются в контейнере относительно основных осей и их направление"
      }, {
          "property": "flex-flow",
          "descr": "Является сокращённым свойством для отдельных свойств flex-direction и flex-wrap"
      }, {
          "property": "flex-grow",
          "descr": "Определяет, сколько пространства может занимать флекс внутри контейнера"
      }, {
          "property": "flex-shrink",
          "descr": "Определяет коэффициент сжатия флексов в контейнере"
      }, {
          "property": "flex-wrap",
          "descr": "Указывает, следует ли флексам располагаться в одну строку или можно занять несколько строк"
      }, {
          "property": "float",
          "descr": "Определяет, по какой стороне будет выравниваться элемент, при этом остальные элементы будут обтекать его с других сторон"
      }, {
          "property": "font",
          "descr": "Универсальное свойство, которое позволяет одновременно задать несколько характеристик шрифта и текста"
      }, {
          "property": "font-family",
          "descr": "Устанавливает семейство шрифта, которое будет использоваться для оформления текста содержимого"
      }, {
          "property": "font-kerning",
          "descr": "Управляет кернингом шрифта — это изменение интервала между определёнными сочетаниями букв для сохранения плотности букв в тексте"
      }, {
          "property": "font-size",
          "descr": "Определяет размер шрифта элемента"
      }, {
          "property": "font-stretch",
          "descr": "Устанавливает узкое, нормальное или широкое начертание шрифта, что позволяет уплотнять или расширять текст"
      }, {
          "property": "font-style",
          "descr": "Определяет начертание шрифта — обычное, курсивное или наклонное"
      }, {
          "property": "font-variant",
          "descr": "Определяет, как нужно представлять строчные буквы — оставить их без модификаций или делать их все прописными уменьшенного размера"
      }, {
          "property": "font-weight",
          "descr": "Устанавливает насыщенность шрифта"
      }]
  },
  "HIJ": {
      "gTitle": "H, I, J",
      "el": [{
          "property": "height",
          "descr": "Устанавливает высоту элементов"
      }, {
          "property": "hyphens",
          "descr": "Сообщает браузеру, как расставлять переносы слов в блоке текста"
      }, {
          "property": "image-rendering",
          "descr": "Сообщает браузеру, каким алгоритмом интерполировать изображение при масштабировании его размеров или изменении масштаба в параметрах браузера"
      }, {
          "property": "justify-content",
          "descr": "Определяет, как браузер распределяет пространство вокруг флекс-элементов вдоль главной оси контейнера"
      }]
  },
  "L": {
      "gTitle": "L",
      "el": [{
          "property": "left",
          "descr": "Устанавливает положение левого края элемента"
      }, {
          "property": "letter-spacing",
          "descr": "Определяет интервал между букв в тексте"
      }, {
          "property": "line-clamp",
          "descr": "Ограничивает текст заданным числом строк"
      }, {
          "property": "line-height",
          "descr": "Устанавливает высоту строки текста"
      }, {
          "property": "list-style",
          "descr": "Универсальное свойство, позволяющее одновременно задать стиль маркера, его положение, а также изображение маркера"
      }, {
          "property": "list-style-image",
          "descr": "Устанавливает адрес изображения, которое служит в качестве маркера списка"
      }, {
          "property": "list-style-position",
          "descr": "Определяет, как будет размещаться маркер относительно текста"
      }, {
          "property": "list-style-type",
          "descr": "Изменяет вид маркера для каждого элемента списка"
      }]
  },
  "M": {
      "gTitle": "M",
      "el": [{
          "property": "margin",
          "descr": "Устанавливает внешний отступ от каждого края элемента"
      }, {
          "property": "margin-bottom",
          "descr": "Устанавливает величину отступа от нижнего края элемента"
      }, {
          "property": "margin-left",
          "descr": "Устанавливает величину отступа от левого края элемента"
      }, {
          "property": "margin-right",
          "descr": "Устанавливает величину отступа от правого края элемента"
      }, {
          "property": "margin-top",
          "descr": "Устанавливает величину отступа от верхнего края элемента"
      }, {
          "property": "max-height",
          "descr": "Устанавливает максимальную высоту элемента"
      }, {
          "property": "max-width",
          "descr": "Устанавливает максимальную ширину элемента"
      }, {
          "property": "min-height",
          "descr": "Задаёт минимальную высоту элемента"
      }, {
          "property": "min-width",
          "descr": "Устанавливает минимальную ширину элемента"
      }, {
          "property": "mix-blend-mode",
          "descr": "Определяет режим наложения исходного цвета на фоновый цвет или фоновое изображение"
      }]
  },
  "O": {
      "gTitle": "O",
      "el": [{
          "property": "object-fit",
          "descr": "Управляет соотношением сторон изображений и видеороликов, а также способом их масштабирования"
      }, {
          "property": "opacity",
          "descr": "Определяет уровень прозрачности элемента"
      }, {
          "property": "order",
          "descr": "Определяет порядок вывода флексов внутри флекс-контейнера"
      }, {
          "property": "orphans",
          "descr": "Задаёт минимальное число строк текста, которое остается на предыдущей странице при печати документа"
      }, {
          "property": "outline",
          "descr": "Одновременно устанавливает цвет, стиль и толщину внешней границы на всех четырёх сторонах элемента"
      }, {
          "property": "outline-color",
          "descr": "Задаёт цвет внешней границы элемента"
      }, {
          "property": "outline-offset",
          "descr": "Устанавливает расстояние между рамкой, созданной с помощью свойства outline, и краем или границей элемента добавленной через border"
      }, {
          "property": "outline-style",
          "descr": "Задаёт стиль внешней границы элемента"
      }, {
          "property": "outline-width",
          "descr": "Задаёт толщину внешней границы элемента"
      }, {
          "property": "overflow",
          "descr": "Управляет отображением содержимого элемента, если оно целиком не помещается в область заданных размеров"
      }, {
          "property": "overflow-x",
          "descr": "Управляет отображением содержимого блочного элемента по горизонтали"
      }, {
          "property": "overflow-y",
          "descr": "Управляет отображением содержимого блочного элемента по вертикали"
      }]
  },
  "P": {
      "gTitle": "P",
      "el": [{
          "property": "padding",
          "descr": "Устанавливает значение полей вокруг содержимого элемента"
      }, {
          "property": "padding-block",
          "descr": "Одновременно задаёт начальный и конечный внутренние отступы логического блока"
      }, {
          "property": "padding-block-end",
          "descr": "Определяет конечный внутренний отступ логического блока."
      }, {
          "property": "padding-block-start",
          "descr": "Определяет начальный внутренний отступ логического блока."
      }, {
          "property": "padding-bottom",
          "descr": "Устанавливает значение поля от нижнего края содержимого элемента"
      }, {
          "property": "padding-inline",
          "descr": "Одновременно задаёт начальный и конечный строчные внутренние отступы логического блока"
      }, {
          "property": "padding-inline-end",
          "descr": "Определяет конечный строчный внутренний отступ логического блока"
      }, {
          "property": "padding-inline-start",
          "descr": "Определяет начальный строчный внутренний отступ логического блока"
      }, {
          "property": "padding-left",
          "descr": "Устанавливает значение поля от левого края содержимого элемента"
      }, {
          "property": "padding-right",
          "descr": "Устанавливает значение поля от правого края содержимого элемента"
      }, {
          "property": "padding-top",
          "descr": "Устанавливает значение поля от верхнего края содержимого элемента"
      }, {
          "property": "page-break-after",
          "descr": "Добавляет разрыв страницы при печати документа после заданного элемента"
      }, {
          "property": "page-break-before",
          "descr": "Добавляет разрыв страницы при печати документа перед заданным элементом"
      }, {
          "property": "page-break-inside",
          "descr": "Разрешает или запрещает разрыв страницы внутри элемента при печати"
      }, {
          "property": "perspective",
          "descr": "Определяет расстояние от плоскости экрана до точки сходимости линий и тем самым задаёт, насколько выражен эффект перспективы"
      }, {
          "property": "perspective-origin",
          "descr": "Задаёт координаты точки, куда смотрит наблюдатель; свойство работает совместно с perspective и определяет точку сходимости линий при перспективе"
      }, {
          "property": "place-content",
          "descr": "Одновременно устанавливает значения свойств align-content и justify-content"
      }, {
          "property": "pointer-events",
          "descr": "Свойство pointer-events позволяет управлять тем, как элементы будут реагировать на события мыши или прикосновения к сенсорному экрану"
      }, {
          "property": "position",
          "descr": "Устанавливает способ позиционирования элемента относительно окна браузера или других объектов на веб-странице"
      }]
  },
  "QRS": {
      "gTitle": "Q, R, S",
      "el": [{
          "property": "quotes",
          "descr": "Устанавливает тип кавычек, который применяется в тексте документа"
      }, {
          "property": "resize",
          "descr": "Указывает, можно ли пользователю изменять размеры текстового поля"
      }, {
          "property": "right",
          "descr": "Устанавливает положение правого края элемента"
      }, {
          "property": "scroll-behavior",
          "descr": "Определяет поведение прокрутки внутри элемента — плавная прокрутка или мгновенный переход"
      }]
  },
  "T": {
      "gTitle": "T",
      "el": [{
          "property": "tab-size",
          "descr": "Используется для изменения ширины отступа, заданного с помощью символа табуляции"
      }, {
          "property": "table-layout",
          "descr": "Определяет, как браузер должен вычислять ширину ячеек таблицы, основываясь на её содержимом"
      }, {
          "property": "text-align",
          "descr": "Определяет горизонтальное выравнивание текста"
      }, {
          "property": "text-align-last",
          "descr": "Задаёт выравнивание последней строки текста, когда свойство text-align установлено как justify"
      }, {
          "property": "text-decoration",
          "descr": "Добавляет оформление текста в виде его подчёркивания, перечёркивания, линии над текстом"
      }, {
          "property": "text-decoration-color",
          "descr": "Устанавливает цвет линии, которая добавляется через свойство text-decoration"
      }, {
          "property": "text-decoration-line",
          "descr": "Определяет, как должна добавляться декоративная линия к тексту — подчёркивание, перечёркивание, над текстом"
      }, {
          "property": "text-decoration-style",
          "descr": "Устанавливает стиль декоративной линии, которая добавляется к тексту через свойство text-decoration или text-decoration-line"
      }, {
          "property": "text-decoration-skip-ink",
          "descr": "Задаёт, как выводить линию под или над текстом, когда линия пересекает выносные элементы букв, вроде «у», «р», «ц» и др."
      }, {
          "property": "text-emphasis",
          "descr": "Сокращённое свойство, позволяющее установить значения свойств text-emphasis-style и text-emphasis-color одновременно"
      }, {
          "property": "text-emphasis-color",
          "descr": "Устанавливает цвет маркеров, отображаемых с помощью свойства text-emphasis-style"
      }, {
          "property": "text-emphasis-position",
          "descr": "Устанавливает положение маркеров, отображаемых с помощью свойства text-emphasis-style"
      }, {
          "property": "text-emphasis-style",
          "descr": "Устанавливает вид визуальных маркеров над каждым символом текста"
      }, {
          "property": "text-indent",
          "descr": "Устанавливает величину отступа первой строки блока текста"
      }, {
          "property": "text-orientation",
          "descr": "Устанавливает ориентацию текстовых символов в строке"
      }, {
          "property": "text-overflow",
          "descr": "Определяет параметры видимости текста в блоке, если текст целиком не помещается в заданную область"
      }, {
          "property": "text-shadow",
          "descr": "Добавляет тень к тексту, а также устанавливает её параметры"
      }, {
          "property": "text-transform",
          "descr": "Управляет преобразованием текста элемента в заглавные или прописные символы"
      }, {
          "property": "top",
          "descr": "Устанавливает положение верхнего края содержимого элемента"
      }, {
          "property": "transform",
          "descr": "Трансформирует элемент, в частности, позволяет его масштабировать, вращать, сдвигать, наклонять, а также комбинировать виды трансформаций"
      }, {
          "property": "transform-origin",
          "descr": "Устанавливает координаты точки, относительно которой будет происходить трансформация элемента"
      }, {
          "property": "transform-style",
          "descr": "Определяет, как дочерние элементы будут отображаться в 3D-пространстве"
      }, {
          "property": "transition",
          "descr": "Универсальное свойство, которое определяет эффект перехода между двумя состояниями элемента"
      }, {
          "property": "transition-delay",
          "descr": "Устанавливает время ожидания перед запуском эффекта анимации перехода"
      }, {
          "property": "transition-duration",
          "descr": "Задаёт время в секундах или миллисекундах, сколько должна длиться анимация перехода до её завершения"
      }, {
          "property": "transition-property",
          "descr": "Устанавливает имя стилевого свойства, значение которого будет отслеживаться для создания эффекта перехода"
      }, {
          "property": "transition-timing-function",
          "descr": "Устанавливает, насколько быстро должно изменяться значение стилевого свойство для которого применяется эффект перехода"
      }]
  },
  "UV": {
      "gTitle": "U, V",
      "el": [{
          ...
          "descr": "Задаёт, как должен располагаться текст"
      }, {
          "property": "user-select",
          "descr": "Управляет поведением выделения текста и других элементов на странице"
      }, {
          "property": "vertical-align",
          "descr": "Выравнивает элемент по вертикали относительно своего родителя, окружающего текста или ячейки таблицы"
      }, {
          "property": "visibility",
          "descr": "Предназначен для отображения или скрытия элемента"
      }]
  },
  "W": {
      "gTitle": "W",
      "el": [{
          ...
          "descr": "Устанавливает, как отображать пробелы между словами"
      }, {
          "property": "widows",
          "descr": "Задаёт минимальное число строк текста, которое располагается на следующей странице при печати документа"
      }, {
          "property": "width",
          "descr": "Устанавливает ширину элемента"
      }, {
          "property": "word-break",
          "descr": "Указывает, как делать перенос строк внутри слов, которые не помещаются по ширине в заданную область"
      }, {
          "property": "word-spacing",
          "descr": "Устанавливает интервал между словами"
      }, {
          "property": "word-wrap",
          "descr": "Указывает, переносить или нет длинные слова, которые не помещаются по ширине в заданную область"
      }, {
          "property": "writing-mode",
          "descr": "Устанавливает направление текста на странице"
      }]
  },
  "Z": {
      "gTitle": "Z",
      "el": [{
          "property": "z-index",
          "descr": "Задаёт положение элементов по z-оси"
      }, {
          "property": "zoom",
          "descr": "Изменяет масштаб объекта согласно заданному значению"
      }]
  }
};
var indexCSS = new Vue({
  el: '#v-ref-css',
  data: {
  ...
  methods: {
      isShow(key) {
          const find = this.getElementFiltered(key)
          return find.length > 0
      },
      getKeys() {
          return Object.keys(this.CSSProperty)
      },
      getTitleByKey(key) {
          return this.CSSProperty[key].gTitle
      },
      getElementFiltered(group) {
          return this.CSSProperty[group].el.filter(x => x.property.startsWith(this.searchCSS, 0));
      }
  }
});;
! function(e, n) {
